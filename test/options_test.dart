...
void main() {
  ...
  group('non-custom options |', () {
    test('changing metadata changes query parameters', () {
    ...
    test(
      ...
      () {
        ...
        expect(hostOptions.uri.queryParameters.isEmpty, true);
        expect(clusteredOptions.uri.queryParameters.isEmpty, true);
      },
    );
